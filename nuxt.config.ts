...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      // apiBase: 'https://52.187.207.236/api',
      // apiBase: 'https://apiv2.mangaverse.my.id/api',
      // apiBase: 'http://localhost:5000/api',
      // apiBase: 'http://api.himpapoltekba.com:5000/api',
      apiBase: 'https://api.himpapoltekba.com/api',
    },
  },
